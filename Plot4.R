...
Plot4 <- function(){
        ...
        ## Set up panel of 4 plots
        par(mfrow=c(2,2))
        
        ## Draw Plot in Top Left
        plot(dats$days,dats[,3], type="l",ylab="Global Active Power",xlab="",xaxt="n")
        axis(1,at=c(0,(24*60)+1,(2*24*60)+1),labels=c("Thu","Fri","Sat"))
        
        ## Draw Plot in Top Right
        plot(dats$days,dats[,5], type="l",ylab="Voltage",xlab="",xaxt="n")
        axis(1,at=c(0,(24*60)+1,(2*24*60)+1),labels=c("Thu","Fri","Sat"))
        
        ##Draw Plot in Btm Left
        ...
        ##Draw Plot in Btm Right
        plot(dats$days,dats[,4], type="l",ylab="Global reactive power",xlab="",xaxt="n")
        axis(1,at=c(0,(24*60)+1,(2*24*60)+1),labels=c("Thu","Fri","Sat"))
